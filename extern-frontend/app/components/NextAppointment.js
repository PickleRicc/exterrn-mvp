...
export default function NextAppointment({ appointment }) {
  ...
  return (
    <div className="bg-[#132f4c] rounded-2xl p-5 md:p-7 border border-[#223a5e] shadow-lg mb-8 max-w-xl w-full mx-auto animate-fade-in">
      <div className="flex items-center mb-4 gap-3">
        <div className="p-2.5 bg-[#e91e6c]/20 rounded-full">
          <svg className="w-5 h-5 text-[#e91e6c]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
          </svg>
        </div>
        <h2 className="text-lg md:text-xl font-semibold text-white">Nächster Termin</h2>
      </div>
      <div className="bg-[#0a1929]/60 rounded-xl p-4 mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          <div className="text-lg md:text-2xl font-bold text-white mb-1">{appointment.title || appointment.subject || "Termin"}</div>
          <div className="text-[#e91e6c] font-medium text-base md:text-lg">{formattedDate}</div>
        </div>
        <div className="flex items-center">
          <div className="bg-[#223a5e] text-white px-4 py-2 rounded-lg font-mono text-base md:text-lg shadow-sm">
            {formattedTime} Uhr
          </div>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div className="flex items-start">
          <div className="p-2 bg-[#223a5e]/60 rounded-full mr-3 mt-0.5">
          ...
          <div>
            <div className="text-blue-300 text-xs mb-1">Ort</div>
        ...
        <div className="flex items-start">
          ...
          <div>
            <div className="text-blue-300 text-xs mb-1">Kunde</div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3">
        ...
        <Link
          ...
          className="text-[#e91e6c] hover:text-white bg-[#223a5e]/60 hover:bg-[#e91e6c]/20 px-4 py-2 rounded-lg transition-colors text-sm font-semibold text-center w-full md:w-auto"
        >
          Details anzeigen
        </Link>
      </div>
