...
export default function Home() {
  return (
    <>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 pt-16 pb-8 bg-gradient-to-b from-[#0a1929] to-[#132f4c] text-white">
        <div className="max-w-2xl text-center mb-8">
          ...
          <div className="flex flex-col items-center w-full">
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
              ...
              <Link 
                href="/auth/register" 
                className="px-8 py-3 border border-white/30 hover:bg-white/10 text-white font-medium rounded-xl focus:outline-none transition-all duration-300 transform hover:-translate-y-0.5"
              >
                Register
              </Link>
            </div>
          ...
          <div className="mt-8 mb-12 flex flex-col items-center">
            <span className="uppercase text-xs tracking-widest text-white/60 mb-2">Trusted by modern craftsmen</span>
          ...
          <section className="w-full max-w-5xl mx-auto grid md:grid-cols-3 gap-6 mt-4 mb-16 px-2">
            <div className="bg-[#132f4c]/80 backdrop-blur-sm rounded-2xl p-6 flex flex-col items-center text-center shadow-lg border border-white/10">
